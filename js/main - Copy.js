...
document.addEventListener("DOMContentLoaded", function () {
  ...
  */
  ...
  function loadAOS(url) {
    return new Promise(function (resolve, reject) {
      var script = document.createElement("script");
      script.src = url;
      var mainScript = document.querySelector("script[src='./js/main.min.js']");
      mainScript.parentElement.insertBefore(script, mainScript);
      ...
      script.onerror = function () {
        throw new Error("Error in loading AOS script");
      };
    });
  }

  var promiseLoadAOS = loadAOS("https://unpkg.com/aos@2.3.1/dist/aos.js");
  promiseLoadAOS.then(function () {
    return AOS.init();
  });
  ...
  document.querySelector(".menu-icon").addEventListener("click", function () {
    if (document.body.classList.contains("_menu")) closeMenu();else openMenu();
  });
  ...
  document.querySelector(".header .social__img").addEventListener("click", function () {
    if (document.body.classList.contains("_socials")) headerSocialsClose();else headerSocialsOpen();
  });
  ...
  headerSelect.addEventListener("click", function (evt) {
    if (headerSelect.classList.contains("_active")) headerSelectClose();else headerSelectOpen();
  });
